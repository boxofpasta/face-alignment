...
transform_test = False # ignored if use_samples == True
ibug_version = False
...
if ibug_version:
    ...
    downloads_path = '/mnt/Data/Data/face/'
...
if transform_test and not use_samples:
    if ibug_version:
        ...
        im_path = downloads_path + '/face_attributes_images'
        coords_path = downloads_path + '/face_attributes_pts_81'
...
if transform_train or use_samples:
    if ibug_version:
        ...
        im_paths = [downloads_path + '/face_attributes_images']
        coords_path = downloads_path + '/face_attributes_pts_81'
